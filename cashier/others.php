        ...
        <div class="row">
            <div class="col-md-8 card padding-y-sm card ">
                <ul class="nav bg radius nav-pills nav-fill mb-3 bg" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="pill" href="others.php">
                ...
                <span id="items">
							<div class='row'>
							<?php
                            $query = "SELECT * FROM buku WHERE genre='Others'";
							...
							<table class="table table-hover shopping-cart-wrap">
                                ...
                                if(isset($_POST['add_to_cart'])) {
                                    ...
                                    if(mysqli_num_rows($select) > 0){
                                        ...
                                        $insert = "INSERT INTO cart (kode_barang,judul_buku,gambar,harga_jual,harga_asli,nama_kasir,qty,hargatot) VALUES('$kode_barang','$judul_buku','$gambar','$harga_jual','$harga_asli','$nama','$qty','$hargaot')";
